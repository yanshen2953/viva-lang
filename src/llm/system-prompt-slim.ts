...
- Multi-panel: widget layout.figure (cols/rows) then widget chart.* with panel: a (not areaX / inset* magic numbers; compiler estimates chrome). Single-column mm charts can omit areaX/areaY; the compiler fills the scene. Two or more charts with no panel/area become a figure grid.
