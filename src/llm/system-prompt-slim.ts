...
- Video/image board: widget layout.board (safe/title/body/lower; splits: 2 → left/right; beats: 4 → beat0..; bleed: 16 → bleed/trim + crop marks). Scene unit: mm and column: single (89) or double (183). Frame xScale/yScale: log|band|time. ISO dates auto-time. String columns auto-band. Legend defaults outside (legend: right|bottom|inside|false).
