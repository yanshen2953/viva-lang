...
- Widgets: timeline; chart.scatter / chart.line / chart.bar / chart.heatmap (macro expands to frame + axes + marks). Prefer xLabel/yLabel + xUnit/yUnit, and errorField for uncertainty. Hover readout is default (__tip); set interactive: false to disable.
