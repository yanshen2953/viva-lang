...
- Widgets: timeline; chart.scatter / chart.line / chart.bar / chart.heatmap / chart.vector / chart.funnel / chart.box / chart.violin; layout.figure (omit inset* / x/y/w/h — compiler estimates chrome, fills the scene or a board slot via panel: body, paints title/subtitle/caption); layout.board (safe/title/body/lower, title/subtitle/caption props, optional splits/beats/bleed/typeGrid; export --beats is a PNG sequence, not video). Charts bind with panel: a. Standalone charts may omit areaX/areaY; compiler fills the scene. Prefer xLabel/yLabel + xUnit/yUnit, errorField, xScale: log|band|time. Legend defaults outside. Defaults: __tip + __hover + __brush (data-domain dx* + linked xField) + __highlightGrp + __sel.keys; interactive: false to disable. Scene unit: mm + column: single|double.
