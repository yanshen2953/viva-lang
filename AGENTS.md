...
| Beat slideshow | `npx vite-node src/cli.ts -- export examples/storyboard.viva --beats -f gif -o /tmp/story.gif` (ffmpeg stitch, not a timeline; CI installs ffmpeg, tests skip the stitch without it) |
